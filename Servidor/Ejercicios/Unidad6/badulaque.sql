...
(1, 'Tomates', 0.5, 'kg', 50, 'img/productos/tomates.png'),
(2, 'Plátanos', 1, 'kg', 20, 'img/productos/platanos.png'),
(3, 'Arroz', 0.8, 'kg', 37, 'img/productos/arroz.png'),
...
GRANT USAGE ON *.* TO 'badulaque'@'localhost' IDENTIFIED BY PASSWORD '*D73ADC4B6CEDF53AA60A5816DAE2A1FAD78A9A29';

GRANT ALL PRIVILEGES ON `badulaque`.* TO 'badulaque'@'localhost' WITH GRANT OPTION;