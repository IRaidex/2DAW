...
define('LOCATION_WSDL', 'http://localhost.servidor/wsdl/simple_service_definition.wsdl');
define('LOCATION_NO_WSDL', 'http://localhost.servidor/no_wsdl/server_endpoint.php');
